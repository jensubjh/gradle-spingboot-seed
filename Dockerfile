...
Gist
 ...
 Watch 4
  Star 13
  Fork 32 jorgemoralespou/s2i-java
 Code  Issues 1  Pull requests 1  Projects 0  Wiki  Pulse  Graphs
Branch: master Find file Copy paths2i-java/Dockerfile
4d57924  on Sep 23, 2016
@jorgemoralespou jorgemoralespou Added settings.xml to allow for injecting MAVEN_MIRROR_URL
1 contributor
RawBlameHistory    
59 lines (46 sloc)  2.4 KB
# s2i-java
